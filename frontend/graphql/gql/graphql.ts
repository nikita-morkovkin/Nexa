...
export type FindChannelByUsernameQuery = { __typename?: 'Query', findChannelByUsername: { __typename?: 'UserModel', id: string, username: string, bio?: string | null, avatar?: string | null, isVerified: boolean, displayName: string, stream: { __typename?: 'StreamModel', title: string, thumbnailUrl?: string | null, isLive: boolean, category: { __typename?: 'CategoryModel', title: string } } } };
